...
response = requests.get(
    f"https://api.unsplash.com/search/photos?per_page={total_images}&query={category}&client_id=ulOsUswB9Kc3jw87iSJkZha54XD0CjWBss0PmW6sdv0")
...
for _ in range(500):
    ...
    item_fake_text = fake.text(max_nb_chars=200)
    item = (item_id, item_first_name, item_price,
            item_picture_path, item_city_name, item_fake_text)
    items.append(item)
